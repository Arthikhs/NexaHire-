        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold">
              Our Mission At <span className="text-blue-600">Nexa</span><span className="text-red-500">Hire</span>
            </h1>
...
auto"
            >
              At NexaHire, we're dedicated to revolutionizing the job search
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl opacity-80">
              Join thousands of successful job seekers on NexaHire
            </p>
            <div className="pt-4">
              <Link href="/jobs">
